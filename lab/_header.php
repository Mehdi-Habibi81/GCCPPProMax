...
<nav class="topnav">
    <div class="topnav-inner">
        ...
        <a
            href="indicator"
            class="<?= $activeNav === 'indicator' ? 'active' : '' ?>"
        >
            دفتر اندیکاتور
        </a>
        ...
        <a
            href="internal_sheet"
            class="<?= $activeNav === 'internal' ? 'active' : '' ?>"
        >
            لاگ‌شیت‌های داخلی
        </a>
        ...
        <a
            href="analytics"
            class="<?= $activeNav === 'analytics' ? 'active' : '' ?>"
        >
            آنالیز
        </a>
